          ...
          <div className="flex flex-col gap-12 md:flex-row md:items-center">
            <div className="md:w-1/2">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mt-6 mb-6 max-w-3xl">
                Transform the way of communicationof teaches to students.
              </h1>
              <p className="text-lg md:text-xl mb-8 max-w-xl text-blue-100">
                Your complete digital classroom where teachers share notes,
                assign work, track attendance, and evaluate progress with
                clarity and control.
              </p>
