        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          {mySubmission ? (
            ...
            <form onSubmit={handleFileUpload}>
              {isLate && (
                <p className="text-red-500 mb-2">Assignment is late!</p>
              )}
              <div className="mb-4">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={4}
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-2 border resize-none"
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  onClick={() => handleGrade(gradingSubmissionId)}
